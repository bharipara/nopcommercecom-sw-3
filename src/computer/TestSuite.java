...
//    Write the following Test:
    ...
    public void verifyProductArrangeInAlphaBaticalOrder() {
        ...
        //1.4 erify the Product will arrange in Descending order.
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        verifyFromElement(By.xpath("//span[@id='price-value-1']"), "$1,470.00");
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"), "Joy");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"), "Harris");
        sendTextToElement(By.name("BillingNewAddress.Email"), "Joy123@gmail.com");
        selectByValueFromDropDown(By.xpath("//select[@id='BillingNewAddress_CountryId']"), "33");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"),"London");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Address1']"),"1, Real Street");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"),"W126TA");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"),"020324323");
