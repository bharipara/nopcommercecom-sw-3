...
//        green Bar
        verifyFromElement(By.xpath("//p[text()='The product has been added to your ']"), "The product has been added to your shopping cart");
...
//        2.20 Fill the mandatory fields
        sendTextToElement(By.name("FirstName"), "Tom");
        sendTextToElement(By.name("LastName"), "Jerry");
        sendTextToElement(By.xpath("//input[@id='Email']"), "Tom1234@gmail.com");
        sendTextToElement(By.name("Password"), "abc123");
        sendTextToElement(By.id("ConfirmPassword"), "abc123");
//        2.21 Click on “REGISTER” Button
        clickOnElement(By.xpath("//button[contains(text(),'Register')]"));
//        2.22 Verify the message “Your registration completed”
        verifyFromElement(By.xpath("//div[contains(text(),'Your registration completed')]"), "Your registration completed");
...
//        2.27 Fill the Mandatory fields
        ...
        sendTextToElement(By.id("CardholderName"), "Jay Viru");
        //Enter card number
